...
class RankOtherListPage extends StatefulWidget {
  RankOtherListPage({
    Key key,
    @required this.id,
    @required this.title,
  ...
  @override
  State<StatefulWidget> createState() => RankOtherListPageState();
}

class RankOtherListPageState extends State<RankOtherListPage> {
